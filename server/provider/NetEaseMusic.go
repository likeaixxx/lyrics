...
func (search NetEaseMusic) search(key string) (model.NetEaseSearchResponse, bool) {
	...
	header := map[string]string{"User-Agent": "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/66.0.3359.139 Safari/537.36", "Host": "music.163.com"}
